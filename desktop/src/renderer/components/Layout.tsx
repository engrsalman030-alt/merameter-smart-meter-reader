...
const Layout: React.FC<LayoutProps> = ({
    ...
    const [appName, setAppName] = useState(
        localStorage.getItem("appName") || "MeraMeter"
    );
    ...
    useEffect(() => {
        const updateBranding = () => {
            setAppName(localStorage.getItem("appName") || "MeraMeter");
            setAppLogo(localStorage.getItem("appLogo") || "");
            setUserName(localStorage.getItem("userName") || "Admin");
            setUserImage(localStorage.getItem("userImage") || "");
            setCurrentTheme((localStorage.getItem("theme") as "light" | "dark") || "light");
        };
    ...
    return (
        <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300 w-full overflow-hidden">
            <aside className="hidden md:flex flex-col w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 shrink-0">
                <div className="p-6 border-b border-slate-100 dark:border-slate-800">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <h1 className="text-lg font-bold text-slate-900 dark:text-white truncate">{appName}</h1>
                ...
                <div className="p-4 border-t border-slate-100 dark:border-slate-800 space-y-4">
                    <div className="flex items-center justify-between">
                        <div className={`flex items-center gap-2 text-xs font-medium ${isOnline ? "text-emerald-500" : "text-red-500"}`}>
